...
public class TEA {
    ...
    public static String quote = "joem";
    public static String quote2 = "mikem";
...
//        TEA tea = new TEA("And is there honey still for tea?".getBytes());
        ...
        byte[] original2 = quote2.getBytes();

        /* Run it through the cipher... and back */
        byte[] crypt2 = tea.encrypt(original2);
        byte[] result2 = tea.decrypt(crypt2);

        /* Ensure that all went well */
        String test2 = new String(result2);
